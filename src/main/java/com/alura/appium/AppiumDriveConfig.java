...
public class AppiumDriveConfig {
    public final AppiumDriver driver;
    private static AppiumDriveConfig _instance;

    public static AppiumDriveConfig Instance(){
        if (AppiumDriveConfig._instance == null){
            AppiumDriveConfig._instance = new AppiumDriveConfig();
        }
        return AppiumDriveConfig._instance;
    }

    private AppiumDriveConfig(){
        File apk = new File("C:\\Users\\cesar.cordeiro\\Desktop\\alura\\src\\main\\resources\\alura_esporte.apk");
